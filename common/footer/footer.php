<?php include('customFunctions/getFanCountFacebook.php'); ?>
<div id="footer-widgets" class="container">
			...
			<div class="footer-widget span3 block4">
				<div class="widget">
					<h3 class="title"><span>সামাজিক যোগাযোগ সাইট</span></h3>
						<div class="socmed clearfix">		
							<ul>
								<li>
									<a href="https://www.youtube.com/channel/UC9uGcPtsbTvw3YGzlbZfaqQ" target="_blank">
								...
								<li>
									<a href="https://www.facebook.com/TalimuddinF" target="_blank"><img src="images/fb-icon.png" alt=""></a>
									<h4></h4>
									<p>Fans</p>
								</li>
							</ul>
